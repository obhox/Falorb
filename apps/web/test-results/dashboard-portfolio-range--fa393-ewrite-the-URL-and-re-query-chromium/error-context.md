...
- Name: dashboard.spec.ts >> portfolio >> range changes rewrite the URL and re-query
- Location: e2e/dashboard.spec.ts:29:3
...
Call log:
  - waiting for getByRole('button', { name: '7 days' })
