...
- Name: dashboard.spec.ts >> people >> search narrows the list through the URL
- Location: e2e/dashboard.spec.ts:97:3
...
Call log:
  - waiting for getByPlaceholder('Search email, name or id')
